...
Usage:
    ...
    python -m stable_pretraining.run --config-path ../examples/geodro --config-name geodro_lejepa_fake_data_smoke
    ...
    python -m stable_pretraining.run --multirun \
        --config-path ../examples/geodro --config-name geodro_lejepa_fake_data_smoke \
